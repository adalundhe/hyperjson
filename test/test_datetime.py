...
class TestDatetime:
    def test_datetime_naive(self):
        ...
        """
        assert (
            hyperjson.dumps([datetime.datetime(2000, 1, 1, 2, 3, 4, 123)])
    ...
    def test_datetime_microsecond_max(self):
        ...
        """
        assert (
            hyperjson.dumps(datetime.datetime(2000, 1, 1, 0, 0, 0, 999999))
    ...
    def test_datetime_microsecond_min(self):
        ...
        """
        assert (
            hyperjson.dumps(datetime.datetime(2000, 1, 1, 0, 0, 0, 1))
    ...
    def test_datetime_omit_microseconds(self):
        ...
        assert (
            hyperjson.dumps(
                [datetime.datetime(2000, 1, 1, 2, 3, 4, 123)],
                option=hyperjson.OPT_OMIT_MICROSECONDS,
            )
    ...
    def test_datetime_utc_z_naive(self):
        ...
        assert (
            hyperjson.dumps(
                [datetime.datetime(2000, 1, 1, 2, 3, 4, 123)],
                option=hyperjson.OPT_NAIVE_UTC | hyperjson.OPT_UTC_Z,
            )
    ...
    def test_datetime_roundtrip(self):
        ...
        serialized = hyperjson.dumps(obj).decode("utf-8").replace('"', "")
...
class TestDate:
    def test_date(self):
        ...
        datetime.date
        """
        assert hyperjson.dumps([datetime.date(2000, 1, 13)]) == b'["2000-01-13"]'
...
class TestTime:
    ...
    def test_time_microsecond_max(self):
        ...
        """
        assert hyperjson.dumps(datetime.time(0, 0, 0, 999999)) == b'"00:00:00.999999"'

    def test_time_microsecond_min(self):
        """
        datetime.time microsecond min
        """
        assert hyperjson.dumps(datetime.time(0, 0, 0, 1)) == b'"00:00:00.000001"'
